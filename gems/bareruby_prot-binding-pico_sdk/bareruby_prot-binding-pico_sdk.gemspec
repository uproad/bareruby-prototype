...
require_relative "lib/bareruby_prot/binding/pico_sdk/version"

Gem::Specification.new do |spec|
  spec.name = "bareruby_prot-binding-pico_sdk"
  spec.version = BareRubyProt::Binding::PicoSdk::VERSION
  spec.authors = ["uproad"]
  spec.email = ["7349115+uproad@users.noreply.github.com"]

  spec.summary = "Reaches Raspberry Pi Pico boards through pico-sdk."
  spec.description = "Reaches RP2040 and RP2350 boards through pico-sdk: what it builds with, and how it flashes."
