...
require_relative "lib/bareruby_prot/stdlib/pwm/version"

Gem::Specification.new do |spec|
  spec.name = "bareruby_prot-stdlib-pwm"
  spec.version = BareRubyProt::Stdlib::Pwm::VERSION
  spec.authors = ["uproad"]
  ...
  spec.description = "The PWM class: what a program may ask of a timer channel, and what that lowers to."
