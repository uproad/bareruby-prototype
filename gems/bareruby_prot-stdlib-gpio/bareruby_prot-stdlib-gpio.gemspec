...
require_relative "lib/bareruby_prot/stdlib/gpio/version"

Gem::Specification.new do |spec|
  spec.name = "bareruby_prot-stdlib-gpio"
  spec.version = BareRubyProt::Stdlib::Gpio::VERSION
  spec.authors = ["uproad"]
  spec.email = ["7349115+uproad@users.noreply.github.com"]

  spec.summary = "The GPIO class: what a program may say to a pin, and what that lowers to."
  spec.description = "The GPIO class: what a program may say to a pin, and what that lowers to."
