...
require_relative "lib/bareruby_prot/stdlib/adc/version"

Gem::Specification.new do |spec|
  spec.name = "bareruby_prot-stdlib-adc"
  spec.version = BareRubyProt::Stdlib::Adc::VERSION
  spec.authors = ["uproad"]
  ...
  spec.description = "The ADC class: what a program may ask of a converter channel, and what that lowers to."
