...
require_relative "lib/bareruby_prot/binding/arduino/version"

Gem::Specification.new do |spec|
  spec.name = "bareruby_prot-binding-arduino"
  spec.version = BareRubyProt::Binding::Arduino::VERSION
  spec.authors = ["uproad"]
  spec.email = ["7349115+uproad@users.noreply.github.com"]

  spec.summary = "Reaches Arduino boards through the Arduino core."
  spec.description = "Reaches Arduino boards: the toolchain it builds with, and how an artifact gets onto one."
