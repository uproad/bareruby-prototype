...
| `array_of_objects.rb` | A fixed-capacity array whose elements are objects — a class the program wrote and a peripheral class alike. Created into the element, reached in place, bound to a local, handed to a method, and held as an instance variable. Matches real Ruby |
